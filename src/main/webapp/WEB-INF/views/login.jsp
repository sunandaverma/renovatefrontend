...
<body style="text-align:center;background-image:url(resources/login2.jpg);background-attachment:fixed;background-repeat:no-repeat;width:100%;">
<jsp:include page="/WEB-INF/views/header.jsp"/>
<br><br>
<div class="container">
    <div id="login-page" class="row">
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            <h1 style=color:white class="text-center login-title">Sign In to Rennovate</h1><br>
            <div class="account-wall">
                ...
                <br>
                <button style="background-color:Gray;" class="btn btn-lg btn-primary btn-block" type="submit">Sign in</button>
                <button style="background-color:Gray;" class="btn btn-lg btn-primary btn-block" type="reset" >Cancel</button>
                <br>
