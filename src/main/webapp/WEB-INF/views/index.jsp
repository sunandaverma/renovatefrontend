...
<title>RENNOVATE-All Sides</title>

</head>
<body  style="background-image:url(resources/grey.jpg);background-attachment:fixed;">
...
<div id="myCarousel" class="carousel slide" data-ride="carousel" style="top:50px">
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="resources/curtain.jpg" alt="pizza" style="width:100%;height:60%" >
    </div>

    <div class="item">
      <img src="resources/drystems.jpg" alt="pizza" style="width:100%;height:60%">
    </div>

    <div class="item">
      <img src="resources/3lamp.jpg" alt="pizza" style="width:100%;height:60%">
    </div>
    
    <div class="item">
      <img src="resources/lamphanging.jpg" alt="pizza" style="width:100%;height:60%">
    </div>
  </div>
